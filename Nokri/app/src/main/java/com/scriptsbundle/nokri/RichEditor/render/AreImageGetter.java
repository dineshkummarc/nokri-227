    ...
    public Drawable getDrawable(String source) {
        if (source.startsWith(Constants.EMOJI)) {
            ...
            try {
                ...
                Glide.with(mContext).asBitmap().load(source).into(bitmapTarget);
            }catch (Exception e){
                e.printStackTrace();
            }
            ...
            try {
                ...
                Glide.with(mContext).asBitmap().load(uri).into(bitmapTarget);
                return areUrlDrawable;
...
//import Constants;
//import Util;
//import com.scriptsbundle.nokri.RichEditor.android.inner.Html;
//import AreImageSpan;
//import ARE_Image;
